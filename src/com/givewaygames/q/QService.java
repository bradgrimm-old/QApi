...
public class QService {
    ...
    private static final String BLUETOOTH_NAME = "BluetoothQ";

    // Unique UUID for this application
    private static final UUID Q_UUID = UUID.fromString("63432ad0-c574-11e1-9b21-0800200c9a66");
     ...
     */
    public QService(Context context, BluetoothDataListener dataListener) {
...
//        mHandler.sendMessage(msg);
    ...
    private class AcceptThread extends Thread {
		...
		public AcceptThread() {
            ...
            try {
                tmp = mAdapter.listenUsingInsecureRfcommWithServiceRecord(BLUETOOTH_NAME, Q_UUID);
            } catch (IOException e) {
    ...
    private class ConnectThread extends Thread {
		...
		public ConnectThread(BluetoothDevice device) {
            ...
            try {
                tmp = device.createInsecureRfcommSocketToServiceRecord(Q_UUID);
            } catch (IOException e) {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    dataListener.onDataReceived(buffer, bytes);
                } catch (IOException e) {
